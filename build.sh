...
eval $CXX \
    Source/*.cpp \
    Work/*.o \
    Libraries/imgui-1.53/*.cpp \
    Libraries/imgui-1.53/examples/libs/gl3w/GL/gl3w.c \
    Libraries/imgui-1.53/examples/sdl_opengl3_example/imgui_impl_sdl_gl3.cpp \
    `sdl2-config --cflags` \
    -I Libraries/imgui-1.53/ \
    -I Libraries/imgui-1.53/examples/libs/gl3w/ \
    `sdl2-config --libs` \
